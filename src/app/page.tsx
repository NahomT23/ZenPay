...
export default function Home() {
  return (
    <main className="mt-10 flex flex-col justify-center items-center h-screen text-center max-w-5xl mx-auto px-4">
      <h1 className="mt-10 text-4xl md:text-6xl font-extrabold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-green-500">
        Welcome to PayZen
      </h1>
      ...
      <section
        ...
        className="mt-20 text-left w-full px-4 space-y-12"
      >
        <h2 className="text-2xl md:text-4xl font-semibold text-gray-800">Why Choose PayZen?</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="p-6 bg-white shadow-lg rounded-lg">
            <h3 className="text-xl md:text-2xl font-bold text-blue-600">Effortless Invoicing</h3>
            <p className="text-gray-600 mt-2 text-sm md:text-base">
              Create and manage invoices in just a few clicks with our intuitive interface.
            </p>
          </div>
          <div className="p-6 bg-white shadow-lg rounded-lg">
            <h3 className="text-xl md:text-2xl font-bold text-green-600">Secure Payments</h3>
            <p className="text-gray-600 mt-2 text-sm md:text-base">
              Accept payments securely with robust encryption and trusted integrations.
            </p>
          </div>
          <div className="p-6 bg-white shadow-lg rounded-lg">
            <h3 className="text-xl md:text-2xl font-bold text-yellow-600">Real-Time Analytics</h3>
            <p className="text-gray-600 mt-2 text-sm md:text-base">
              Gain insights into your business performance with detailed analytics.
            </p>
          </div>
      ...
      <footer className="mt-auto py-6 text-gray-600 text-xs md:text-sm">
        © {new Date().getFullYear()} PayZen. All rights reserved.
      </footer>
    </main>
  );
